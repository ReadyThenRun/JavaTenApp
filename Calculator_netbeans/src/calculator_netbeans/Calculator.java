...
public class Calculator extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if(content.length()>0){
            jTextField1.setText(content.substring(0,content.length()-1));        // TODO add your handling code
        }
        ...
        while(m.find()){
            ...
            switch(opr)
            {
                ...
                case '/':
                    ...
                    break;
                default:
                    jTextField1.setText("Data paser Error, please input again!");           
            }                
        }    
    }
